...
/*уменьшение меню в шапке*/
$(document).scroll(function() {
	if($(document).scrollTop()>200)
	{
		/*Шапка маленькая*/
		$(".header-top").css('padding','1px 0 1px 15px');
		/*$(".header-top").css('background','#333333');*/
	...
	{
		/*Шапка большая*/
		$(".header-top").css('padding','15px 0 20px 15px');
		/*$(".header-top").css('background','rgba(7,7,7,0.3)');*/
		$("#logo").attr('src','images/logo.png');
	}
})
/*Подмена картинки видео*/
$('#at').hover(function(){
...
var videoA = function () {this.innerHTML = '<video width="100%" src="images/MacBook Pro 13 2019- This Will Surprise You.mp4"  controls autoplay>'}; 
document.querySelector('.video-center').addEventListener('click', function (e) { this.removeEventListener('click', videoA, false); videoA.apply(this, arguments); } , false);
/* /Воспроизведение видео*/

/*Воспроизведение видео youtube
var videoA = function () {this.innerHTML = '<iframe src="https://www.youtube.com/embed/NFOd5-HASDM?list=PLtrvASfI1KW7EYt8EFAXKEDXk4o2Xsl23" frameborder="0" allowfullscreen></iframe>'}; 
document.querySelector('.video-center').addEventListener('click', function (e) { this.removeEventListener('click', videoA, false); videoA.apply(this, arguments); } , false);
 /Воспроизведение видео youtube*/
